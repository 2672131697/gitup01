...
<head>
    ...
    <script type="text/javascript">
        // 书本上架
        function doSj(bookId){
            location.href='doSj?bookId='+bookId;
        }
    </script>
</head>
<body>
...
<div class="w960">
    ...
    <jsp:forward page="/listBook?forward=listBook1&bookStatus=0"/>
    </c:if>
             ...
             <c:forEach items="${bookList}" var="v">
                ...
                <tr>
                    ...
                    <td width="30%" class="text">
                        <a href="input/uploadBookImage?bookId=${v.bookId}">图片上传</a>
                        <a href="toEditBook?bookId=${v.bookId}">修改</a>
                        <a href="delBook?bookId=${v.bookId}">删除</a>

                        <a href="javascript:doSj(${v.bookId})">上架</a>
                    </td>
                </tr>
             </c:forEach>
            </table>
